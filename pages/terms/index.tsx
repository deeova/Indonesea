...
const index = () => {
  return (
    <>
      <main>
        <section className="bg-terms bg-cover bg-no-repeat bg-[center_bottom]">
        ...
        <article className="w-full px-5 lg:px-0 lg:w-[1082px] mx-auto flex flex-col gap-5 py-50 lg:py-100 text-justify text-base">
          ...
          <p>
            ...
            general terms and conditions of your use of the indonesea.com
            ...
            and Indonesea (&ldquo;Indonesea&rdquo;, &ldquo;we&rdquo;,
            ...
            Indonesea, even though it is electronic and is not physically signed
          ...
          <p>
            ...
            against Indonesea with respect to such other services. Indonesea is
            ...
            expressly permitting Indonesea to disclose your data as necessary to
          ...
          <p>
            ...
            Indonesea, its affiliates, directors, officers, employees, agents,
            ...
            law, the aggregate liability of Indonesea and its affiliates,
            officers, employees, agents, suppliers and licensors relating to the
            services will be limited to an amount no greater than one pound or
            any amounts actually paid in cash by you to Indonesea for the prior
          ...
          <p>
            You agree to indemnify and hold Indonesea and its affiliates,
          ...
          <p>
            ...
            and procedural laws of Indonesia without regard to its rules on
            conflicts or choice of law and, to the extent applicable, the laws
            of Indonesia. The exclusive jurisdiction and venue for actions
            related to the subject matter hereof shall be the courts located in
            Indonesia, and you hereby submit to the personal jurisdiction of
          ...
          <p>This document was last updated on January 05, 2024.</p>
        </article>
      </main>
      <Footer />
    </>
