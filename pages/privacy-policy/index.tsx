  ...
  return (
    <LayoutPolicy>
      <main>
        ...
        <article className="w-full px-5 lg:px-0 lg:w-[1082px] mx-auto flex flex-col gap-5 py-50 lg:py-100 text-justify text-base">
          <p>
          ...
          <p>
            ...
            indonesea.com website (&ldquo;Website&rdquo; or
          ...
          <p>
            ...
            Indonesea (&ldquo;Indonesea&rdquo;, &ldquo;we&rdquo;,
            ...
            agreement, in which case the terms &ldquo;User&rdquo;,
          ...
          <p>
            ...
            Information and we comply with data controllers&rsquo; obligations
          ...
          <p>
            We rely on the user's consent as a legal base as defined in the GDPR
          ...
          <p>
            ...
            processors (&ldquo;Payment Processors&rdquo;) to assist us in
          ...
          <p>
            ...
            including Indonesia. The transfer of your Personal Information to
          ...
          <p>
            <strong>Data protection rights under the GDPR</strong>
          </p>
          <p>
            If you are a resident of the European Economic Area
            (&ldquo;EEA&rdquo;), you have certain data protection rights and we
          ...
          <p>
            ...
            further information on the cookies we collect and their purpose, see
            our cookie policy. Please note that you have the ability to accept
            or decline cookies. Most web browsers automatically accept cookies
            by default, but you can modify your browser settings to decline
          ...
          <p>
            ...
            your Personal Information. For a description of Do Not Track
            protocols for browsers and mobile devices or to learn more about the
            choices available to you, visit internetcookies.com
          </p>
          <p>
          ...
          <p>
            ...
            via email in accordance with applicable laws and regulations.
          </p>
          <p>
          ...
          <p>
            ...
            materially different from what was stated at the time your Personal
          ...
          <p>
            <strong>Submit a data access request</strong>
          </p>
          <p>
          ...
          <p>https://indonesea.com/contact/</p>
          <p>
